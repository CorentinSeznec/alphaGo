...
while not b.is_game_over():
    start_time_all_turn = time.time()
    
    
    #print("Referee Board:")
    b.prettyPrint() 
    print("MCTS player is Black - X") if classNames[0] == "mctsPlayer" else print("MCTS player is White - O")
    ...
    end_time_all_turn = time.time()
    with open('readme.txt', 'a') as file:   
        file.write("\ntime took for whole turn:"+str(end_time_all_turn - start_time_all_turn)+ "\n\n\n")
